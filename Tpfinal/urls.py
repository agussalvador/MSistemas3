...
from boards.views import GenericCreateTask, GenericCreateCategory, GenericUpdateTask, GenericDeleteTask, TaskViewSet
from register import views as v
from rest_framework.routers import DefaultRouter

router = DefaultRouter()
router.register('task-user', TaskViewSet, basename='task-user')
